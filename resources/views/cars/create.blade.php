            ...
            <form action="{{ route('cars.show') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="brand" id="" class="form-control form-control-sm" placeholder="Brand">
                    </div>
                    <div class="col-6">
                        <label for="" class="control-label">Model</label>
                        <input type="text" name="model" id="" class="form-control form-control-sm" placeholder="Model">
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" name="color" id="" class="form-control form-control-sm" placeholder="Color">
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" name="km" id="" class="form-control form-control-sm" placeholder="Km">
                    </div>
                    <div class="col-6">
